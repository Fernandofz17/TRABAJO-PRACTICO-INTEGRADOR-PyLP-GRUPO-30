...
## 👤 Integrante 1: Fabricio Molina

*Usuario GitHub:* fabriciomolina012-collab
...
## 👤 Integrante 2: Silva Armand, Alejandro Omar

*Usuario GitHub:* xrasa
...
## 👤 Integrante 3: Nicolás Javier Mancedo

*Usuario GitHub:* nicolasman3011
...
## 👤 Integrante 4: Zacarias Blanco, Fernando Ivan

*Usuario GitHub:* Fernandofz17

### 1. Código en Common Lisp (Fase 1 y 2)

* [ ] Desarrollo 100% Humano
* [x] Asistencia de IA (nivel intermedio)
* [ ] Generación Completa por IA

*Detalle:*
Durante el desarrollo del trabajo utilicé herramientas de Inteligencia Artificial como apoyo para resolver dudas de sintaxis, comprender mejor algunas funciones de Common Lisp, configurar bibliotecas externas y detectar errores durante las pruebas. La implementación de las funciones, la interpretación de los requerimientos y las decisiones tomadas para resolver el problema fueron realizadas por todo el grupo en conjunto.

### 2. Código del Lenguaje Asignado (Fase 3)

* [ ] Desarrollo 100% Humano
* [x] Asistencia de IA (nivel alto)
* [ ] Generación Completa por IA

*Detalle:*
Utilicé herramientas de IA para familiarizarme con la sintaxis de OCaml y comprender conceptos propios del lenguaje, como los tipos algebraicos y el pattern matching. La adaptación de las funciones solicitadas y el análisis comparativo fueron realizados a partir de la comprensión de los conceptos trabajados en la materia.
...
*Detalle:*
Se utilizó IA como apoyo para generar un esqueleto inicial y posteriormente mejorar sus secciones. También se empleó para optimizar la redacción, organización y presentación del informe, procurando reflejar fielmente el trabajo realizado y los conocimientos adquiridos durante el desarrollo del proyecto.

### Declaración Jurada

Declaro que la información consignada anteriormente refleja de manera fiel el proceso de desarrollo de este trabajo práctico y el uso realizado de herramientas de Inteligencia Artificial. Asimismo, me comprometo a poder explicar y defender las decisiones de diseño e implementación tomadas durante el proyecto.
